...
@Component
public class QuotePublisher2FanoutExchange {

	/** The logger */
	private static final Logger LOGGER = Logger.getLogger(QuotePublisher2FanoutExchange.class);

	private static final String FANOUT_EXCHANGE = "fanout_asset_exchange";
	 ...
	 * @param amqpTemplate
	 */
	public QuotePublisher2FanoutExchange(AmqpAdmin amqpAdmin, AmqpTemplate amqpTemplate) {
		this.amqpAdmin = null;
	...
	public void publish() {
		...
		for (int i=0; i<10; i++){
			...
			amqpTemplate.convertAndSend(FANOUT_EXCHANGE, null,asset.toString());
